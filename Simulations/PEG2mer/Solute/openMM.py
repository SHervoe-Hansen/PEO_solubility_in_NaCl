...
pdb = app.PDBFile('/work/1/ERCINCR/stefan/PEO-Solubility/PDB_files/PEO-2-mer.pdb')
...
app.PDBFile.writeFile(modeller.topology, modeller.positions, open('PEG_2_hydrated.pdb', 'w'))
