...
pdb = app.PDBFile('/work/1/ERCINCR/stefan/PEO-Solubility/PDB_files/PEO-15-mer.pdb')
...
app.PDBFile.writeFile(modeller.topology, modeller.positions, open('PEG_15_hydrated.pdb', 'w'))
