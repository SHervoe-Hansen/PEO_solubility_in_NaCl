...
pdb = app.PDBFile('/work/1/ERCINCR/stefan/PEO-Solubility/PDB_files/PEO-6-mer.pdb')
...
app.PDBFile.writeFile(modeller.topology, modeller.positions, open('PEG_6_hydrated.pdb', 'w'))
