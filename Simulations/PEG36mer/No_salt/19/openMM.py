...
pdb = app.PDBFile('PEG_36_No_salt.pdb')
...
integrator = mm.LangevinMiddleIntegrator(0.15*u.kelvin, 100.0/u.picoseconds, 0.1*u.femtoseconds)
...
sim.step(500000)  # 500000*0.1 fs = 50 ps
