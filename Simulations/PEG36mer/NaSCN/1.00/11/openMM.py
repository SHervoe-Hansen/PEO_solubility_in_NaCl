...
pdb = app.PDBFile('PEG_36_NaSCN.pdb')
...
integrator = mm.LangevinMiddleIntegrator(0.15*u.kelvin, 100.0/u.picoseconds, 0.01*u.femtoseconds)
...
sim.step(1500000) # 1500000*0.01 fs = 15 ps 
