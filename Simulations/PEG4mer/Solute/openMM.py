...
pdb = app.PDBFile('/work/1/ERCINCR/stefan/PEO-Solubility/PDB_files/PEO-4-mer.pdb')
...
app.PDBFile.writeFile(modeller.topology, modeller.positions, open('PEG_4_hydrated.pdb', 'w'))
